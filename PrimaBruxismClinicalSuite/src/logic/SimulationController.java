...
public class SimulationController {
    ...
    public static void runSimulation(File simulationDataFolder) {
        try {
            ...
            PatientProfile patient = CSVParser.loadFullPatientProfile(simulationDataFolder.getAbsolutePath());
            ...
            RedFlagDetector redFlagDetector = new RedFlagDetector(null);
            risk.setRedFlags(redFlagDetector.detect(patient.toMap()));
